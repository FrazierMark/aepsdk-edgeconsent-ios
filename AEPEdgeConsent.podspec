Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/FrazierMark/aepsdk-edgeconsent-ios.git"
  s.license          = { :type => "Apache License, Version 2.0", :file => "LICENSE" }
  s.author           = "Adobe Experience Platform SDK Team"
  s.source           = { :git => "https://github.com/FrazierMark/aepsdk-edgeconsent-ios.git", :tag => s.version.to_s }
